...
case "$SCENARIO" in
dpmi|pm|int31|rm|vec|sb|dos|mem|pm32|alias) VSB_BIN="${VSB_BIN:-$ROOT/build/out/vsb_dpmi.com}" ;;
...
[ "$SCENARIO" = "alias" ] && mcopy -i "$OUT/harness.img" "$ROOT/build/out/testalias.com" ::/TESTALI.COM
